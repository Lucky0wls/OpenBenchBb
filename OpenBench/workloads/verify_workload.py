...
def verify_scale_nps_fields(errors, request):
    if request.POST['scale_method'] == 'BOTH':
        verify_integer(errors, request, 'dev_scale_nps', 'Dev Scale NPS')
        verify_greater_than(errors, request, 'dev_scale_nps', 'Dev Scale NPS', 0)
        verify_integer(errors, request, 'base_scale_nps', 'Base Scale NPS')
        verify_greater_than(errors, request, 'base_scale_nps', 'Base Scale NPS', 0)
    else:
        verify_integer(errors, request, 'scale_nps', 'Scale NPS')
        verify_greater_than(errors, request, 'scale_nps', 'Scale NPS', 0)
